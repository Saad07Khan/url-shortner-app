    ...
    <div className="container mx-auto p-2">
      <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
        <div className="w-full h-full rounded-xl p-20 backdrop-brightness-50">
          ...
          Provide your link here to have it shortened.
          </p>
          <p className="text-white text-center pb-4 text-sm font-thin">
          Use our free URL shortener tool to simplify or condense your links. Create clean and concise URLs that are easy to use and share.
          </p>
          <form onSubmit={handleSubmit}>
            <div className="flex">
              <div className="relative w-full">
                ...
                <button
                  type="submit"
                  className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-[#301934] rounded-lg border border-[#301934] focus:ring-4 focus:outline-none focus:ring-blue-300"
                >
                  Shorten URL
                </button>
              </div>
